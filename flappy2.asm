...
DetectCollision:
	...
	sta $64
	lda $040D;40C is the top end pipe
	cmp $64
	bcs _executeResult
	...
	sbc #$10
	sta $64
	lda $041D;40C is the top end pipe
	cmp $64
	bcs _executeResult
	bra _endDectCol;changed from _endDectCol to _determinePointsPipe1
	;_executeResult2:
	...
	lda $41C; pick a pipe sprite from the second column. Any pipe from column 2 will do. I randomly chose the one with an X axis address of $41C
	clc
	adc #$02
	sta $40
	lda $40
